...
public class SenderCommandFactoryTest
{
    ...
    public void RegisterSender()
    {
        ...
        SenderDTO senderDTO = new SenderDTO("JDAirsoft", "jdairsoft@gmail.com", "55 road lake, cannock", "B449XH", "password", "password");
    ...
    public void LoginSender()
    {
        ...
        SenderDTO senderDTO = new SenderDTO("JDAirsoft", "jdairsoft@gmail.com", "55 road lake, cannock", "B449XH", "pass", "pass");
