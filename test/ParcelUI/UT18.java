...
import dbase.DatabaseConn;
import static dbase.DatabaseConn.getConnection;
 ...
 * @author jackg
 */
public class UT18 extends DatabaseConn
{
    ...
    ParcelDTO parcelDTO = new ParcelDTO(107, 1, "JDAirsoft", "Paul COllins", "jdairsoft@gmail.com", "just4paul@gmail.com",
            "Tm Recoil", "10x10x10", null, "B867YK", "6797Jhgf97lO", "On route", date);
    ...
    public UT18() throws SQLException
    {
